...
const generateInitialBookings = (): Booking[] => {
    ...
    const bookings: Booking[] = [
        {
            ...
            additionalWorkNotes: 'Filter AC sangat kotor, perlu diganti pada service berikutnya. Pipa pembuangan juga dibersihkan dari lumut.',
    ...
    savePhoto('1-arrival', 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=100&h=100&fit=crop');
    savePhoto('1-before', 'https://images.unsplash.com/photo-1603013822817-1bb13ce59a74?w=100&h=100&fit=crop');
    savePhoto('1-after', 'https://images.unsplash.com/photo-1598870150334-26ecf6311634?w=100&h=100&fit=crop');
    savePhoto('2-arrival', 'https://images.unsplash.com/photo-1581822261290-991b38693d1b?w=100&h=100&fit=crop');
...
export const generateTimeSlots = (startHour: number, endHour: number, breakStartHour: number, breakEndHour: number, intervalMinutes: number): string[] => {
    const slots: string[] = [];
    const date = new Date();
    ...
    try {
        ...
        if (storedBookings) {
            ...
            const bookingsWithDefaults = parsedBookings.map(b => ({
                ...
                photos: b.photos || {},
                additionalWorkNotes: b.additionalWorkNotes || '',
                additionalCosts: b.additionalCosts || 0,
            }));
            bookingsWithDefaults.sort((a, b) => new Date(a.startDate).getTime() - new Date(b.startDate).getTime() || a.id - b.id);
...
const initialUsers: User[] = [
    ...
    { id: 2, name: 'Bambang Wijoyo', username: 'bambang', password: 'password123', role: 'technician' },
    { id: 3, name: 'Tim Kebersihan A', username: 'tim_a', password: 'password123', role: 'technician' },
